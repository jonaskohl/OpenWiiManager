...
namespace System.Windows.Forms
{
    ...
    /// </summary>
    public class ExtraKeysConverter : TypeConverter, IComparer
    {
        ...
        private void Initialize()
        {
            ...
            _keyNames = new Dictionary<string, Keys>();
            _displayOrder = new List<string>();
                ...
                else
                {
                    ...
                    for (int i = 0; i < tokens.Length; i++)
                    {
                        ...
                        if ((currentKey & Keys.KeyCode) != 0)
                        {
                            ...
                            if (foundKeyCode)
                            {
                                throw new FormatException("Key combination is not valid.");
                            }
